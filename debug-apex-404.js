...
async function debugApex404() {
  ...
  console.log('1. Login page: https://apex-fit-two.vercel.app/auth/owner-login')
  console.log('2. Direct dashboard: https://apex-fit-two.vercel.app/owner/dashboard')
  console.log('3. Home page: https://apex-fit-two.vercel.app/')
  console.log('')
  ...
  console.log('===================')
  console.log('')
  console.log('Option A: Check Vercel environment variables')
  console.log('1. Go to: https://vercel.com/mathewbutler10-stack/ALEX-Fit/settings/environment-variables')
  ...
  console.log('3. If local works → Vercel deployment issue')
  console.log('')
